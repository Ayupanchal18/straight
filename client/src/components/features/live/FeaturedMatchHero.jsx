    ...
    >
      ...
      <div className="px-4 sm:px-6 py-3 border-b border-white/[0.05] bg-white/[0.015] flex items-center justify-between gap-4">
        <div className="flex items-center gap-2 min-w-0">
          <span className="flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[10px] font-extrabold uppercase tracking-wider bg-emerald-500/15 text-emerald-400 border border-emerald-500/30 flex-shrink-0">
        ...
        <div className="flex items-center gap-2.5 flex-shrink-0">
          ...
          <div className="flex items-center gap-1 text-emerald-400 group-hover:translate-x-0.5 transition-transform text-xs font-bold">
